"""
Django settings for grad_na_dlanu_48774 project.
...
ROOT_URLCONF = 'grad_na_dlanu_48774.urls'
...
WSGI_APPLICATION = 'grad_na_dlanu_48774.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Grad na dlanu Support <support@grad-na-dlanu-48774.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "grad_na_dlanu_48774 API",
    "DESCRIPTION": "API documentation for grad_na_dlanu_48774 App",
    "VERSION": "v1",
}
